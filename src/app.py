...
activities = {
    ...
    "Music Club": {
        "description": "Learn instruments, sing, and perform in concerts",
        "schedule": "Tuesdays, Thursdays, and Fridays, 3:30 PM - 4:45 PM",
        "max_participants": 25,
        "participants": ["aria@mergington.edu", "julian@mergington.edu"]
    },
    "Science Club": {
